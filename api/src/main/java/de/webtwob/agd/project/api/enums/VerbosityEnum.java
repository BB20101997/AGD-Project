...
/**
 * Stop at everything with a lower or equal level, unless level is
 * Integer.MAX_VALUE than stop nowhere or Skip everything with a greater level
 * or with Integer.MAX_VALUE
 */
