...
public interface IController {
	...
	/**
	 * @param goForwardAutoplay
	 *            if the animation should auto play forward
	 */
	...
	/**
	 * Changes the current graph returns true if successful (false to give error
	 * message in view)
	 * 
	 * @param file
	 *            the file to load the graph from
